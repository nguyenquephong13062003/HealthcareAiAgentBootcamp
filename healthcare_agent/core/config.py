...
PATIENT_MEMORY_PATH = os.path.join(
    STORAGE_DIR,
    "patient_memory.json",
)
...
SAFETY_DISCLAIMER = (
    "This system is for informational purposes only and does not provide "
    "a medical diagnosis. Always consult a licensed healthcare professional."
)
